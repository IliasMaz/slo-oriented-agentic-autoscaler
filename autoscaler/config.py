...
LATENCY_METRICS_WINDOW = get_env("LATENCY_METRICS_WINDOW", QUEUE_METRICS_WINDOW)
...
SCALE_DIRECTION_CHANGE_COOLDOWN_SECONDS = get_env_float("SCALE_DIRECTION_CHANGE_COOLDOWN_SECONDS", 15)  # seconds
