...
OPENAI_MAX_TOTAL_COST_USD = get_env_float("OPENAI_MAX_TOTAL_COST_USD", 0.0)
OPENAI_MAX_TOTAL_TOKENS = get_env_int("OPENAI_MAX_TOTAL_TOKENS", 0)
...
LOG_DIR = get_env("LOG_DIR", "artifacts/logs/autoscaler")
