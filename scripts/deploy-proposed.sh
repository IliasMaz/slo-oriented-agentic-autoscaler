...
kubectl set env deployment/agent-autoscaler \
	...
	MIN_SCALE_ACTION_INTERVAL_SECONDS="${MIN_SCALE_ACTION_INTERVAL_SECONDS:-5}" \
	SCALE_DIRECTION_CHANGE_COOLDOWN_SECONDS="${SCALE_DIRECTION_CHANGE_COOLDOWN_SECONDS:-15}" \
